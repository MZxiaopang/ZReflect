...
public class Customer {
	private Integer customer_id;// 员工ID
	...
	private Date customer_birth;// 出生日期
	private String customer_company;// 客户公司
	private Integer status;// 客户公司状态 正常：2已删除：-2
	...
	public Customer(Integer customer_state_id, Integer customer_source_id, Integer user_id,
			...
			String customer_position, String customer_blog, String customer_tel, Date customer_birth,
			String customer_company, Integer status, String remark, Date create_time, Integer creater, Date update_time,
			Integer updater) {
		super();
		this.customer_state_id = customer_state_id;
		this.customer_source_id = customer_source_id;
