...
<div id="div1">
    <div id="div3">
        ...
        <div id="div3_2">
            ...
            <button id="button2" value="搜索" onclick="f()">添加客户状态</button>
        </div>
    </div>
    <div id="div4">
        <div>
                ...
                <c:if test="${!empty list }">
	                <c:forEach  begin="0" end="${list.size()-1 }" var="i" >
						<tr>
							...
							<td><a href="Customer_StateUpdate?id=${list[i].customer_state_id}&service=Customer_StateUpdate">✎</a>
							<a href="Customer_StateDelete?id=${list[i].customer_state_id}&service=Customer_StateDelete">X</a></td>
						</tr>
					</c:forEach>
					</c:if>
                </tr>
       ...
       <div style="float: right;margin-top: 30px;">
        	<c:forEach var="i" begin="1" end="${page}">
				<a href="Customer_StateServlet?page=${i}&service=Customer_StateGuanLi">第${i}页</a>
			</c:forEach>	
       </div>
...
<script>
    function f() {
    	location.href="${pageContext.request.contextPath }/Customer_StateAdd?service=Customer_StateAdd";
    }
